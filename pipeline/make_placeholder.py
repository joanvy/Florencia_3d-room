...
# right wall, with a hole where the mirror hangs (the viewer renders a real reflection there)
plane([W, 0, 0], [0, 0, D], [0, 0.9, 0], [0.80, 0.74, 0.64])
plane([W, 2.1, 0], [0, 0, D], [0, H - 2.1, 0], [0.80, 0.74, 0.64])
plane([W, 0.9, 0], [0, 0, 1.2], [0, 1.2, 0], [0.80, 0.74, 0.64])
plane([W, 0.9, 2.4], [0, 0, D - 2.4], [0, 1.2, 0], [0.80, 0.74, 0.64])
